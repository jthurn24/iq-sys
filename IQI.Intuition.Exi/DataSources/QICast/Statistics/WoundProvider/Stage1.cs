...
{
    public class Stage1 : BaseReportingProvider
    {

        public Stage1(ICubeRepository c, IDimensionRepository d)
            : base(c, d) { }
        ...
        public override Models.QICast.Statistic GetResult(Guid facilityGuid)
        {
            ...
            result.Description = string.Concat("Stage I <br> P:", Math.Round(priorRate, 3), "<br> C:", Math.Round(currentRate, 3));
