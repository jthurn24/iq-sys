...
{
    public class Stage2 : BaseReportingProvider
    {

        public Stage2(ICubeRepository c, IDimensionRepository d)
            : base(c, d) { }
        ...
        public override Models.QICast.Statistic GetResult(Guid facilityGuid)
        {
            ...
            result.Description = string.Concat("Stage II <br> P:", Math.Round(priorRate, 3), "<br> C:", Math.Round(currentRate, 3));
