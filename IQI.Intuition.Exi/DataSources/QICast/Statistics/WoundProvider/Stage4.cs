...
{
    public class Stage4 : BaseReportingProvider
    {

        public Stage4(ICubeRepository c, IDimensionRepository d)
            : base(c, d) { }
        ...
        public override Models.QICast.Statistic GetResult(Guid facilityGuid)
        {
            ...
            result.Description = string.Concat("Stage IV <br> P:", Math.Round(priorRate, 3), "<br> C:", Math.Round(currentRate, 3));
