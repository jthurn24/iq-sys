...
{
    public class SyncFreshBooksInvoices : IConsoleService
    {
        private ILog _Log;
        private IStatelessDataContext _DataContext;

        public SyncFreshBooksInvoices(
        ...
        public void Run(string[] args)
        {
            ...
            var activeMonth = new DateTime(DateTime.Today.AddMonths(-1).Year,DateTime.Today.AddMonths(-1).Month,1);
