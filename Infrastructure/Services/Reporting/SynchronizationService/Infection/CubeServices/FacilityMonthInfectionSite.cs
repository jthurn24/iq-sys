...
{
    public class FacilityMonthInfectionSite : AbstractMonthlyFacilityCubeService
    {

        private Cubes.FacilityMonthInfectionSite _Cube;
        ...
        protected override void Init(DataDimensions changes)
        {
            ...
            _Cube = GetQueryable<Cubes.FacilityMonthInfectionSite>()
                .Where(x => x.Facility.Id == changes.Facility.Id)
                .FirstOrDefault();

            if (_Cube == null)
            {
                _Cube = new Cubes.FacilityMonthInfectionSite();
                _Cube.Entries = new List<Cubes.FacilityMonthInfectionSite.Entry>();
            ...
            int priorPatientDays)
        {
            ...
            foreach (var infectionSite in changes.InfectionSites)
            {
                ...
                Cubes.FacilityMonthInfectionSite.Entry cube = _Cube.Entries
                ...
                if (cube == null)
                {
                    cube = new Cubes.FacilityMonthInfectionSite.Entry();
                ...
                cube.InfectionSite = infectionSite;
                cube.InfectionType = infectionSite.InfectionType;
