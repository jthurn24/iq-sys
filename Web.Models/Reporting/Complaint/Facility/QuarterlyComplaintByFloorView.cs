...
{
    public class QuarterlyComplaintByFloorView
    {
        ...
        public QuarterlyStatTable<Floor> ComplaintView { get; private set; }
        ...
        public QuarterlyComplaintByFloorView()
        {
        }

        public void SetData(QuarterMonths quarter,
            IEnumerable<FacilityMonthCensus> census,
            IEnumerable<FloorMonthComplaintType.Entry> totals)
        {
            ...
            ComplaintView = new QuarterlyStatTable<Floor>();
        ...
        private void LoadChart(PieChart chart,
            IEnumerable<FloorMonthComplaintType.Entry> data)
        {
            ...
            foreach (var section in sections)
            {
                ...
                {
                    Label = string.Concat(section.Name, " - ", section.Name),
