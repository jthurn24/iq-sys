...
{
    public class PsychotropicDosageChangeFormAddMap : ModelMap<PsychotropicDosageChangeFormAdd, Domain.Models.PsychotropicDosageChange>
    {
        protected IPsychotropicRespository PsychotropicRespository { get; set; }

        public PsychotropicDosageChangeFormAddMap(
        ...
        private void WriteSegments(Domain.Models.PsychotropicDosageChange change, PsychotropicDosageChangeFormAdd form, IEnumerable<DosageSegmentEntry> segments)
        {
